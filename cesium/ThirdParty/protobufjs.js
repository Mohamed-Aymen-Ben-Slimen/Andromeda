 ...
 * @param {Uint8Array} buffer cesium buffer
 * @param {number} start cesium start
 * @param {number} end cesium end
 ...
 * @param {string} string cesium string
 ...
 * @function
 * @param {Uint8Array} buf cesium buffer
 * @param {number} pos cesium buffer offset
 ...
 * @param {Object.<string,*>} src cesium object
